...
| POST   | /auth/login    | Authenticate user            | { "email": "", "password": "" } | { "access_token": "<JWT>" }                                                              | 200, 401      | No         |
| GET    | /park/         | List all parking history     |                                 | [{ "id": "<GUID>", "plate": "", "arrival": "", "departure": "", "duration_seconds": 0 }] | 200, 401      | Yes        |
| POST   | /park/arrive   | Register a vehicle arrival   | { "plate": "" }                 | { "id": "<GUID>", "message": "" }                                                        | 201, 400, 409 | No         |
| PATCH  | /park/depart   | Register a vehicle departure | { "plate": "" }                 | { "message": "" }                                                                        | 200, 400, 404 | No         |
